"""
Django settings for autofill project.
...
SECRET_KEY = '1=2v=9slx63xj)9dx1@nf#miz-h$w#+w32fl6c#!z@up5*dmfi'
...
WSGI_APPLICATION = 'autofill.wsgi.application'
